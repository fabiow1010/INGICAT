...
class Predio(models.Model):
    ...
    PROYECTO_CHOICES = [
        ("PREDIOS PROPIOS", "PREDIOS PROPIOS"),
    ...
    CATEGORIA_PREDIO_FMI_CHOICES = [
        ("COLINDANTE", "COLINDANTE"),
        ("FOLIO ESTUDIO", "FOLIO ESTUDIO"),
        ("MATRIZ", "MATRIZ"),
        ("MATRIZ_COLINDANTE", "MATRIZ_COLINDANTE"),
        ("PROPIO", "PROPIO"),
        ("SEGREGADO", "SEGREGADO"),
        ("SIN INFORMACIÓN", "SIN INFORMACIÓN"),
    ]
    ESTADO_FOLIO_CHOICES = [
        ("ACTIVO", "ACTIVO"),
        ("CERRADO", "CERRADO"),
        ("SIN INFORMACIÓN", "SIN INFORMACIÓN"),
    ]
    CATEGORIA_FMI_CHOICES = [
        ("ADICIONALES", "ADICIONALES"),
        ("COMPLEMENTACIÓN", "COMPLEMENTACIÓN"),
        ("SIN INFORMACIÓN", "SIN INFORMACIÓN"),
        ("TRADICIÓN", "TRADICIÓN"),
    ]
    TIPO_DOCUMENTAL_CHOICES = [
        ("ACTA", "ACTA"),
    ...
    ESTADO_CHOICES = [
        ...
        ("CARGADO EN EL PREDIO", "CARGADO EN EL PREDIO"),
        ("CARGADO EN SHAREPOINT", "CARGADO EN SHAREPOINT"),
        ("NO ENCONTRADO", "NO ENCONTRADO"),
        ("NO REQUIERE", "NO REQUIERE"),
        ("PENDIENTE VERIFICAR", "PENDIENTE VERIFICAR"),
        ("SERVIDOR INGICAT", "SERVIDOR INGICAT"),
    ]
    ...
    SUB_ESTADO_COMPRA_CHOICES = [
        ...
        ("ADQUIRIDO SERVIDUMBRES", "ADQUIRIDO SERVIDUMBRES"),
        ("ERROR REGISTRAL", "ERROR REGISTRAL"),
        ("NO APLICA", "NO APLICA"),
    ...
    ACCION_TECNICA_CHOICES = [
        ("ALIMENTAR EXPEDIENTE PREDIAL", "ALIMENTAR EXPEDIENTE PREDIAL"),
        ("ALIMENTAR PREDIO GESTIÓN", "ALIMENTAR PREDIO GESTIÓN"),
        ("ALIMENTAR PREDIO MATRIZ", "ALIMENTAR PREDIO MATRIZ"),
        ("CARPETA CERO", "CARPETA CERO"),
    ...
    REPETIDO_CHOISES = [
        ("REPETIDO", "REPETIDO"),
        ("UNICO", "UNICO"),
        ("REPETIDO ADQUIRIR", "REPETIDO ADQUIRIR"),
        ("NO APLICA", "NO APLICA"),
    ]
    PAQUETE_CHOISES = [
        ("PAQUETE 4", "PAQUETE 4"),
